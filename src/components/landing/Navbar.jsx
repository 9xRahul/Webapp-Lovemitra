        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              <Link to={user ? "/dashboard" : "/login"} className="gradient-button !py-2.5 !px-6 text-sm text-center">
          ...
          >
            ...
            <div className="flex-grow overflow-y-auto px-8 py-10 bg-white">
              ...
              <div className="mt-12 flex flex-col gap-4">
                <Link to={user ? "/dashboard" : "/login"} onClick={() => setIsOpen(false)} className="w-full text-center gradient-button py-5 text-white font-bold rounded-2xl text-xl shadow-xl">
                  {user ? "Dashboard" : "Login"}
                </Link>
              </div>
            </div>
